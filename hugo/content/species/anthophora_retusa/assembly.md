...
Notes: Assembly statistics were calculated for the primary genome assembly GCA_963995495.1 (CAXEFM01.fasta) using Quast (v5.2.0; Mikheenko et al. 2018). Busco statistics (Manni et al., 2021) were received by communication with the authors. Annotation statistics were calculated for GCA_963995495.1_iyAntRet1_genomic.gff using AGAT (v1.4.1; Dainat, 2024).
