...
Clone the on your computer, and create a branch to work on. Name the
...
In the pull request descriptin, tell us a few words about yourself and
your academic involvement with the proposed species.

That's it! We will be notified, and from then on guide you through the
