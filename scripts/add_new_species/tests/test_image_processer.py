...
def test_process_species_image(example_images: dict[str, Path], tmp_path: Path):
    """
...
def test_warns_with_close_aspect_ratio(example_images: dict[str, Path], tmp_path: Path) -> None:
    """
...
def test_fails_with_bad_aspect_ratio(example_images: dict[str, Path], tmp_path: Path) -> None:
    """
