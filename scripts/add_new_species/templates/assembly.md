...
Notes: Assembly statistics were calculated for the primary genome assembly ${assembly_accession} ([EDIT:genome_assembly_filename]) using Quast (v5.2.0; Mikheenko et al. 2018). Busco statistics (Manni et al., 2021) were provided by the submitting author(s). Annotation statistics were calculated for [EDIT:annotation_file_name] using AGAT (v1.4.1; Dainat, 2024).
